...
//       const costSufficiency = calculateCostSufficiency(cost, 1000); // Example budget of Rs. 1000
...
//   return (
//     <div className="w-full max-w-4xl mx-auto p-10 bg-gradient-to-tl from-green-200 via-blue-100 to-white">
//       <div className="bg-white shadow-xl rounded-2xl p-10 bg-gradient-to-tl from-green-200 via-blue-200 to-white">
//         <div className="flex items-center gap-2 mb-6">
//           <Zap className="w-6 h-6 text-primary" />
//           <h2 className="text-2xl font-semibold">Energy Monitoring</h2>
//         </div>
...
//                           brands[watchProducts[index].product].map((brand) => (
...
//                   <h4 className="font-medium text-blue-900">Total Usage</h4>
//                 </div>
...
//               <h3 className="text-xl font-semibold mb-4">Usage Analysis</h3>
...
//                       <p className="font-medium">{calc.usage.toFixed(2)} kWh</p>
//                     </div>
//                     <div>
//                       <p className="text-sm text-gray-600">Monthly Cost</p>
//                       <p className="font-medium">₹{calc.cost.toFixed(2)}</p>
//                     </div>
//                     <div>
            ...
            <div className="space-y-6">
              {fields.map((field, index) => {
                ...
                return (
                  <div
                    key={field.id}
                    className="p-6 border border-gray-200 rounded-xl bg-gradient-to-tl from-green-200 via-blue-100 to-white shadow-sm hover:shadow-md transition-shadow duration-200"
                  >
                    <div className="flex items-center justify-between mb-6 ">
                      <div className="flex items-center gap-3">
                        <ProductIcon className="w-6 h-6 text-blue-600" />
